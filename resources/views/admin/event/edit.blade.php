                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.events.update', $event->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description_en" id="tinymceContentEn" rows="5" class="form-control">{{ old('description_en', $event->description_en) }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Description (BN)</label>
                                <textarea name="description_bn" id="tinymceContentBn" rows="5" class="form-control">{{ old('description_bn', $event->description_bn) }}</textarea>
                            </div>
