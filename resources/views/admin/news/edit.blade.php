                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.news.update', $news->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                 <div class="col-md-6">
                                       <div class="mb-3">
                                         ...
                                         <input type="text" name="title_en" class="form-control" value="{{ old('title_en', $news->title_en) }}" required />
                                     </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="content_en" id="tinymceContentEn" rows="5" class="form-control">{{ old('content_en', $news->content_en) }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Description (BN)</label>
                                <textarea name="content_bn" id="tinymceContentBn" rows="5" class="form-control">{{ old('content_bn', $news->content_bn) }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Image</label>
                                @if ($news->image)
                                    <div class="mb-2"><img src="{{ asset($news->image) }}" style="height:80px;" alt="img" /></div>
                                @endif
